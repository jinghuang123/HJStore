...
- (void)viewDidLoad {
    ...
    earnTotal.text = [NSString stringWithFormat:@"%.2f",self.info.cumulative_money];
...
- (void)setupNav {
    ...
    [navRightBtn jk_addActionHandler:^(NSInteger tag) {
        HJEarnDetailPage *earnDetail = [[HJEarnDetailPage alloc] init];
        [self.navigationController pushViewController:earnDetail animated:YES];
    }];
}
...
- (void)setTodayEarnView {
    ...
    [todayEarnBgView.rightButton jk_addActionHandler:^(NSInteger tag) {
        ...
        web.policyUrl = kEarnDeatilTipUrl;
...
- (void)setYestodayEarnView {
    ...
    yestodayBgView.payedOrderValue.text = [NSString stringWithFormat:@"%ld",self.info.yesterday_money_count];
    yestodayBgView.earnValue.text = [NSString stringWithFormat:@"¥ %.2f",self.info.yesterday_money];
    yestodayBgView.otherEarnValue.text = [NSString stringWithFormat:@"¥ %.2f",self.info.yesterday_money_else];
...
- (void)setMonthEarnView {
    ...
    monthEarnBgView.payedOrderValue.text = [NSString stringWithFormat:@"¥ %.2f",self.info.month_money_count];
    monthEarnBgView.earnValue.text = [NSString stringWithFormat:@"¥ %.2f",self.info.last_month_money];
    monthEarnBgView.otherEarnValue.text = [NSString stringWithFormat:@"¥ %.2f",self.info.last_month_real_money];
    ...
    monthEarnBgView.rightButton.hidden = YES;
