...
- (UIView *)setViewWithOriginY:(CGFloat)riginY title:(NSString *)title textArr:(NSMutableArray *)textArr
{
    ...
    if ([title isEqualToString:@"最近搜索"]) {
        ...
        btn.frame = CGRectMake(MaxWidth - 45, 10, 28, 30);
...
{
    UIView *historyView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MaxWidth, 80)];
    UILabel *titleL = [[UILabel alloc] initWithFrame:CGRectMake(15, 10, MaxWidth - 30, 30)];
    titleL.text = @"最近搜索";
    titleL.font = [UIFont systemFontOfSize:15];
    titleL.textColor = [UIColor blackColor];
    titleL.textAlignment = NSTextAlignmentLeft;
